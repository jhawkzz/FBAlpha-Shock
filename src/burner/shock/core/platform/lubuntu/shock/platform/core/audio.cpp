...
unsigned long   AudioCore::mSampleFramesPerTick;
snd_pcm_t      *AudioCore::mPcmHandle;
int             AudioCore::mPcmBufferSize;
char            AudioCore::mPcmFeedBuffer[ MAX_PCM_BUFFER_SIZE_BYTES ];
