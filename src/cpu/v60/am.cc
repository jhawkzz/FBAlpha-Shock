...
#include "am1.cc" // ReadAM         // JHM: Changed to .cc so makefile won't compile it
#include "am2.cc" // ReadAMAddress  // JHM: Changed to .cc so makefile won't compile it
#include "am3.cc" // WriteAM        // JHM: Changed to .cc so makefile won't compile it
